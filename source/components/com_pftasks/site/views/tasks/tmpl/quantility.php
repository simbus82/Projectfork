                ...
                foreach($this->items AS $i => $item) :
                    ...
                    <li id="list-item-<?php echo $x; ?>" class="<?php echo $class;?> clearfix <?php if ($item->complete) : echo "complete"; endif;?> priority-<?php echo $item->priority;?>">
                        <div class="task-row clearfix">
	                        ...
	                        <span class="task-title" style="float: left;">
	                        	<div id="nomeprogetto" style="font-size: 10px;line-height: 10px;margin: 0px 5px 0px 10px;color: #999">
	                        ...
	                        <?php
	                        	...
	                        	echo '<span class="label end-date '. ($is_past? 'task-ritardo' : 'task-in-tempo');
								echo ' hasTooltip" rel="tooltip" title="' . ($is_past? 'In ritardo di ' : 'In tempo con ') . abs(round($remaining / 86400)) . ' giorni" style="cursor: help">';
                				echo date("d-M-Y", strtotime($item->end_date));
								echo '</span>';
								echo JHtml::_('pftasks.assignedLabel', $item->id, $x, $item->users);
								echo JHtml::_('pftasks.priorityLabel', $item->id, $x, $item->priority);
	                        ?>
	                        
	                        <small class="task-description" style="margin: 5px 5px 0 0;float: left;">
